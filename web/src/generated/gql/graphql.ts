...
export type ChangeSubscriptionServiceNameMutationVariables = Exact<{
  subscriptionId: Scalars['String'];
  newServiceName: Scalars['String'];
}>;


export type ChangeSubscriptionServiceNameMutation = { __typename?: 'Mutation', changeSubscriptionServiceName: { __typename?: 'Subscription', id: string, price: number, serviceName: string, intervalValue: number, intervalAmount: IntervalAmount, firstPaymentDate: string } };
...
export const ChangeSubscriptionServiceNameDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ChangeSubscriptionServiceName"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"subscriptionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"newServiceName"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"changeSubscriptionServiceName"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"subscriptionId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"subscriptionId"}}},{"kind":"Argument","name":{"kind":"Name","value":"newServiceName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"newServiceName"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"price"}},{"kind":"Field","name":{"kind":"Name","value":"serviceName"}},{"kind":"Field","name":{"kind":"Name","value":"intervalValue"}},{"kind":"Field","name":{"kind":"Name","value":"intervalAmount"}},{"kind":"Field","name":{"kind":"Name","value":"firstPaymentDate"}}]}}]}}]} as unknown as DocumentNode<ChangeSubscriptionServiceNameMutation, ChangeSubscriptionServiceNameMutationVariables>;
